...
class GameManager:
    ...
    async def start_game(self):
        ...
        self.ball_calculator.calculate_ball_prices(self.current_game.balls, self.current_game.initial_price)
    ...
    async def execute_orders(self):
        ...
        try:
            ...
            placed_orders = await self.order_executor.place_orders(self.current_game.balls)
    ...
    def get_game_status(self, participant_uuid: str) -> Optional[Dict]:
        ...
        return {
            ...
            "balls": [
                ...
                for ball in self.current_game.balls if ball.uuid and ball.uuid.strip()  # Only show assigned balls
            ],
